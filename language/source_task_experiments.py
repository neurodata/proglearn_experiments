...
# source_tasks = [
#     {"name": "Yelp Review Sentiment Analysis", "filename": "yelp", "load": load_yelp,},
#     {"name": "IMDB Review Sentiment Analysis", "filename": "imdb", "load": load_imdb,},
#     {
...
#     pickle.dump(
#         accs, open("output/uf_accs_%s_%d.p" % (task["filename"], n_estimators), "wb")
#     )
#     print("----------------------------------------")
...
# Try IMDB if performance gets a lot better with more estimators.
...
pickle.dump(acc, open("output/uf_imdb_%d.p" % n_estimators, "wb"))
